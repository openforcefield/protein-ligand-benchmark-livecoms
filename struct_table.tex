...
\def\ligdens{h}
{\small
\begin{tabular}[t]{l|ll|ll|llll}
Target     & \multicolumn{2}{c|}{Used structure}                          & \multicolumn{2}{c|}{Alternate structures} & \multicolumn{4}{c}{Ligand Information}\\
           &PDB & DPI & 
           &  & N & DR  & $\sigma_{\Delta G}$ & RMSE\\
           & &  &               & & & \multicolumn{3}{c}{[$\mathrm{kcal\,mol^{-1}}$]} \\
...
Jnk1\cite{szczepankiewicz_aminopyridinebased_2006,wang_accurate_2015}       & \notrust{2GMX }{-}\tnote{\jnkfig} & 0.77 
    ...
    \mildlytrust{3ELJ}{0.31}\tnote{\present}
      \end{tabular}
    & \begin{tabular}[t]{p{9em}} 
        \mildlytrust{3V3V}{1.5}\tnote{\similar, \packing}
      \end{tabular} 
    & \ligcount{21}  
    & \ligrange{3.4} 
    & 0.8
