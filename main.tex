...
\newcommand{\githubrepository}{\href{https://github.com/openforcefield/FE-Benchmarks-Best-Practices}{protein-ligand-benchmark-livecoms}}  %this should be the main github repository for this article
