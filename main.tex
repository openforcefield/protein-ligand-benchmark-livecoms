...
%
For the alternate structures, there is one set with the "Hiqhest quality" structure of the protein, and one set with higher quality than the used structure and also high ligand similarity.  > 1.4".
%
...
medium trustworthy (MT) and highly trustworthy (HT) categories. The lower the Iridium score, the better the structure.~\cite{warrenEssentialConsiderationsUsing2012}
