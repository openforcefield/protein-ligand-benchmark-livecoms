...
% Protein-ligand free energy calculations have now become a common tool for prioritizing ligands for synthesis in structure-enabled drug discovery programs
% There are now a great variety of these tools using different methodologies (alchemical methodologies, endpoint methods, minimiziation/rescoring, and machine learning) that can require vastly different amounts of effort
% Despite their importance to drug discovery and chemical biology, there are no standard benchmark sets or common benchmark methodologies in use that allow methods to directly be compared in a manner that will be predictive of their future performance
% Prospective challenges, such as D3R and SAMPL, have demonstrated the enormous utility of focusing the community on common benchmark systems and using common statistical methods to analyze performance
% Here, we collect the shared learnings regarding considerations in the construction of a useful set of protein-ligand benchmarks, the preparation of these systems for use as a common community-wide benchmark, and the appropriate statistical analyses for assessing the accuracy expected of different methods and how methodologies should be compared to see if they offer statistically distinguishable performance
