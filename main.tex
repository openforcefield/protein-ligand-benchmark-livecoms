...
\begin{table*}[h]
\caption{
Evaluation of the quality of structural experimental data of the proposed benchmark set.
%
...
\textbf{Find experimental structural data: Section~\ref{sec:struct_data}}
    ...
    \begin{itemize}
        ...
        \item Ensure experimental data is available, i.e. electron density
    ...
    \begin{itemize}
        ...
        \item Confirm that the ligand has at least partial density (check visually or RSCC > 0.80) and the density is adequate to confirm ligand presence and binding mode
        ...
        \item Check for any missing loops or residues in the structure and confirm these are not near the binding site/not key for the study
    \end{itemize}
...
\textbf{Choose simulation setup: Section~\ref{sec:alchemical_prep}}
    \begin{itemize}
        ...
        \item Plan a a perturbation map if calculations are relative
    \end{itemize}
\end{checklist}
\end{Checklists*}
